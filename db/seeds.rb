...
Request.create([{ datetime: Time.new(2017) , user: 'austin', item_id: 1 , quantity: 5, reason: 'got bored', status: 0, request_type: 'damaged', instances: {instancearray: ["0x35b2", "0x44a5", "0xa241"]}}])
